...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="bg-gradient-to-r from-indigo-50 to-purple-50">
      ...
      <div className="bg-gradient-to-r from-indigo-50 to-purple-50 max-w-8xl mx-auto px-8 sm:px-4 lg:px-12 ">
        <div className="bg-gradient-to-r from-indigo-50 to-purple-50 max-w-7xl mx-auto px-8 sm:px-4 lg:px-12 text-center mb-8 py-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gradient-to-br from-emerald-400 to-teal-500 p-6 rounded-2xl shadow-sm hover:shadow-xl transition duration-300 ease-in-out">
          ...
          <div className="bg-gradient-to-br from-indigo-400 to-blue-500 p-6 rounded-2xl shadow-sm hover:shadow-xl transition duration-300 ease-in-out">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-purple-100">
                <div className="bg-gradient-to-r from-indigo-600 to-purple-600 p-3 rounded-full w-14 h-14 flex items-center justify-center mb-4">
            ...
            <div className="text-center mt-12">
              <Button onClick={handleWhatsAppChat} size="lg" className="bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white">
                <MessageSquare className="mr-2 h-5 w-5" />
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm text-center border border-purple-100">
              <div className="mb-3 text-indigo-600">
                <BarChart3 className="h-10 w-10 mx-auto" />
              </div>
              <h2 className="text-2xl font-bold mb-8 text-center text-indigo-900">Explore</h2>
              <h3 className="font-semibold mb-2 text-indigo-800">5000+ Mutual Funds</h3>
              <p className="text-sm text-indigo-600">Comprehensive coverage of all funds</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center border border-purple-100">
              ...
              <h2 className="text-2xl font-bold mb-8 text-center text-indigo-900">Analyze</h2>
              <h3 className="font-semibold mb-2 text-indigo-800">Real-Time Analytics</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center border border-purple-100">
              ...
              <h2 className="text-2xl font-bold mb-8 text-center text-indigo-900">Invest</h2>
              <h3 className="font-semibold mb-2 text-indigo-800">SIP & Lumpsum Options</h3>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm text-center border border-purple-100">
              ...
              <h2 className="text-2xl font-bold mb-8 text-center text-indigo-900">Personalized for You</h2>
              <h3 className="font-semibold mb-2 text-indigo-800">Personalized Portfolio</h3>
